...
import { MtInputComponent } from './shared/components/mt-input/mt-input.component';
import { MtInscriptionPostulantComponent } from './pages/mt-inscription-postulant/mt-inscription-postulant.component';
import { MtDatatableComponent } from './shared/components/mt-datatable/mt-datatable.component';
import { MtModalContentComponent } from './shared/components/mt-modal-content/mt-modal-content.component';
...
import { MtTooltipComponent } from './shared/components/mt-tooltip/mt-tooltip.component';
...
import { MtNavStepComponent } from './shared/components/mt-nav-step/mt-nav-step.component';
...
import { MtNotificationComponent } from './shared/components/mt-notification/mt-notification.component';
import { MtArticulosComponent } from './pages/mt-articulos/mt-articulos.component';
import { MtPopoverComponent } from './shared/components/mt-popover/mt-popover.component';
import { MtSelectComponent } from './shared/components/mt-select/mt-select.component';
import { MtConfiguracionComponent } from './pages/mt-configuracion/mt-configuracion.component';
import { MtCalendarComponent } from './shared/components/mt-calendar/mt-calendar.component';
import { MtHorarioTiendaComponent } from './pages/mt-horario-tienda/mt-horario-tienda.component';
import { MtTableFilterComponent } from './shared/components/mt-table-filter/mt-table-filter.component';
import { MtTableFilterPapeletasCreadasComponent } from './shared/components/mt-table-filter-papeletas-creadas/mt-table-filter-papeletas-creadas.component';
import { MtTableOficinaComponent } from './shared/components/mt-table-oficina/mt-table-oficina.component';
...
import { MtLoadingComponent } from './shared/components/mt-loading/mt-loading.component';
import { provideAnimationsAsync } from '@angular/platform-browser/animations/async';
import { MtTableMobileComponent } from './shared/components/mt-table-mobile/mt-table-mobile.component';
...
import { MtObservacionHorarioComponent } from './shared/components/mt-observacion-horario/mt-observacion-horario.component';
import { MtPapeletaHorarioComponent } from './shared/components/mt-papeleta-horario/mt-papeleta-horario.component';
import { MtAprobarHorasComponent } from './shared/components/mt-aprobar-horas/mt-aprobar-horas.component';
...
import { MtPapeletaPreviewComponent } from './shared/components/mt-papeleta-preview/mt-papeleta-preview.component';
...
import { MtHrExtraConsolidadoComponent } from './shared/components/mt-hr-extra-consolidado/mt-hr-extra-consolidado.component';
import { MtSearchObervacionComponent } from './shared/components/mt-search-obervacion/mt-search-obervacion.component';
import { MtModalComentarioComponent } from './shared/components/mt-modal-comentario/mt-modal-comentario.component';
import { MtModalViewComentarioComponent } from './shared/components/mt-modal-view-comentario/mt-modal-view-comentario.component';
import { MtKardexContabilidadComponent } from './pages/mt-kardex-contabilidad/mt-kardex-contabilidad.component';
import { MtPopoverNotificacionComponent } from './shared/components/mt-popover-notificacion/mt-popover-notificacion.component';
import { MtIcgreportComponent } from './pages/mt-icgreport/mt-icgreport.component';
import { MtTableTraspasosComponent } from './shared/components/mt-table-traspasos/mt-table-traspasos.component';
